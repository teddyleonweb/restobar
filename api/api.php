...
// Modificar la función upload_and_process_image para mejorar el manejo de errores
function upload_and_process_image($file, $restaurant_id, $category = 'other') {
    ...
    if (!in_array($file['type'], $allowed_formats)) {
        throw new Exception('Formato no permitido: ' . $file['type']);
    }
...
switch ($action) {
    ...
    case 'update-restaurant':
        ...
        // Obtener el restaurante actualizado con imágenes
    ...
    case 'status':
        ...
        send_success([
            ...
            'endpoints' => [
                ...
                'upload-image' => 'POST - Subir imagen',
                'add-restaurant-image' => 'POST - Agregar imagen a galería',
                'update-restaurant-main-image' => 'POST - Actualizar logo/portada',
                'get-restaurant-images' => 'GET - Obtener imágenes',
                'delete-restaurant-image' => 'DELETE - Eliminar imagen',
