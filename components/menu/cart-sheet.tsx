...
export default function CartSheet({
  ...
  const handlePlaceOrder = async () => {
    console.log("CartSheet: handlePlaceOrder iniciada.")
    ...
    const orderItems = cartItems.map((item) => ({
      ...
      // price_at_order: item.price, // No es necesario enviar esto desde el frontend, el backend lo calcula
    ...
    const orderData = {
      ...
      items: orderItems,
      // total_amount: totalPrice, // No es necesario enviar esto desde el frontend, el backend lo calcula
    }

    console.log("CartSheet: Datos del pedido a enviar:", orderData)
    console.log("CartSheet: URL de la API para PLACE_ORDER:", getApiUrl("PLACE_ORDER"))
    console.log("CartSheet: Valor de setCart recibido:", setCart) // Log de depuración

    try {
      const response = await ApiClient.placeOrder(orderData)
      console.log("CartSheet: Respuesta de la API:", response)
      ...
      console.error("CartSheet: Error al realizar pedido:", error)
      toast({
        title: "Error",
